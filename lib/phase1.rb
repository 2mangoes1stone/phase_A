...
# eg. [['2S', '2S', '2H'], ['7H', '7S', '7D']]
def phasea_phase_type(group)

  phase_type = nil

  if group.count == 2 and
    phaseout_phase_one(group[0]) == 1 and
    phaseout_phase_one(group[1]) == 1
...
# puts(phaseout_phase_type([['2S', '2S', '2H'], ['7H', '7S', '7D']]))
#Should return 1
